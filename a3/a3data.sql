...
create table receipts(
	...
	rdate date,
	cid number(2) constraint rec_fk references customers(cust_no)
	);
...
create table item_list(
	rec_no number(5) constraint it_fk1 references receipts(rec_no),
	ordinal number(2),
	item varchar2(20) constraint it_fk2 references products(prod_id),
