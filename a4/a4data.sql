...
create table customers(
	cust_no number(2) constraint c_pk primary key,
	lname varchar2(20),
	fname varchar2(20)
	);
...
create table products(
	prod_id varchar2(20) constraint prod_pk primary key,
	flavour varchar2(20),
	food varchar2(20),
	price number
	);
...
create table receipts(
	rec_no number(5) constraint rec_pk primary key,
	rdate date,
	cid number(2) constraint rec_fk references customers(cust_no) on update cascade on delete cascade
	);
...
create table item_list(
	rec_no number(5) constraint it_fk1 references receipts(rec_no) on delete cascade on update cascade,
	ordinal number(2),
	item varchar2(20) constraint it_fk2 references products(prod_id) on delete cascade on update cascade,
	constraint item_pk primary key(rec_no,ordinal)
	);
...
REM ***	End of database population ***
